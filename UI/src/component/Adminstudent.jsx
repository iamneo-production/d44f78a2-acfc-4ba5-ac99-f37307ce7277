                        ...
                        allStudents && allStudents.map((val)=>{
                            return(
                                <tr>
                                    ...
                                    <td> {val.age}</td>
                                    <td>
                                        <button type="button" id="login_btn" class="btn btn-secondary" onClick={()=>{setEditData(val);setShowEditPopUp(true)}}>Edit</button>&nbsp;&nbsp;
                                        
                                        <button type="button" id="login_btn" class="btn btn-secondary" onClick={()=>{handleDelete(val)}}>Delete</button>
                                    </td>
                                </tr>
                            )
                        })
